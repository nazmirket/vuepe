...
export default class Editor {
	...
	load(components = [], style = {}) {
		...
		this.root.querySelector('.pe-content').addEventListener('click', this.handlers.click)
	}
	...
	getActive() {
		return this.components[this.active]?.cid ? this.components[this.active] : undefined
	}
